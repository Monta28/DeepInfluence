...
export default function Hero() {
  ...
  // Fixed floating elements (no random values)
            ...
            <div className={`space-y-8 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="space-y-6">
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900/50 dark:to-purple-900/50 text-blue-700 dark:text-blue-300 px-4 py-2 rounded-full text-sm font-medium shadow-sm backdrop-blur-sm border border-blue-200/50 dark:border-blue-700/50">
                  ...
                  <span>1000+ experts available now</span>
                </div>

                <h1 className="text-5xl lg:text-7xl font-bold text-gray-900 dark:text-white leading-tight">
                  Connect with
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 relative">
                    <span className="absolute inset-0 animate-pulse bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent blur-sm"></span>
                    <span className="relative">{textRotation[currentText]}</span>
                  </span>
                </h1>

                <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-2xl">
                  DeepInfluence gives you access to an exclusive platform of verified experts, influencers, and certified trainers across all domains: business, wellness, personal development, and much more.
                </p>
              </div>

              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/experts" className="group relative overflow-hidden bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                ...
                <Link href="/demo" className="group relative overflow-hidden border-2 border-blue-600 dark:border-blue-400 text-blue-600 dark:text-blue-400 px-8 py-4 rounded-full text-lg font-semibold hover:bg-blue-600 dark:hover:bg-blue-400 hover:text-white transition-all duration-300 transform hover:scale-105">
                  <span className="relative z-10 flex items-center justify-center">
              ...
              <div className="flex flex-wrap items-center gap-8 pt-8">
                <div className="flex items-center space-x-3 group">
                  <div className="w-12 h-12 bg-gradient-to-br from-green-400 to-emerald-500 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 transform group-hover:scale-110">
                    <i className="ri-shield-check-line text-white text-xl"></i>
                  </div>
                  <div>
                    <span className="text-gray-900 dark:text-white font-semibold">Verified Experts</span>
                    <p className="text-gray-500 dark:text-gray-400 text-sm">100% authenticated</p>
                  </div>
                </div>

                <div className="flex items-center space-x-3 group">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-400 to-cyan-500 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 transform group-hover:scale-110">
                    <i className="ri-secure-payment-line text-white text-xl"></i>
                  </div>
                  <div>
                    <span className="text-gray-900 dark:text-white font-semibold">Secure Payment</span>
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Protected transactions</p>
                  </div>
                </div>

                <div className="flex items-center space-x-3 group">
                  <div className="w-12 h-12 bg-gradient-to-br from-purple-400 to-pink-500 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 transform group-hover:scale-110">
                    <i className="ri-customer-service-line text-white text-xl"></i>
                  </div>
                  <div>
                    <span className="text-gray-900 dark:text-white font-semibold">24/7 Support</span>
              ...
              <div className="grid grid-cols-3 gap-8 pt-8 border-t border-gray-200/50 dark:border-gray-700/50">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-500 dark:text-gray-400">Verified Experts</div>
                </div>
                <div className="text-center">
