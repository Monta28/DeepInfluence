...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      alert(`Inscription réussie en tant que ${userType === 'user' ? 'utilisateur' : 'expert'} !`);
    }, 2000);
  };
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 pr-12 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-colors ${
